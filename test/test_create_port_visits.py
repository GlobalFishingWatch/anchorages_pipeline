...
expected_1 = OrderedDict([('visit_id', '79028318cc7d067946432ff85274dc51'), ('ssvid', 'None'), ('vessel_id', 'None'), 
...
expected_2 = OrderedDict([('visit_id', '781d4f1a61686b40bb44ffaf5cc6a48a'), ('ssvid', 'None'), ('vessel_id', 'None'), 
...
expected_3 = [
    OrderedDict([('visit_id', 'b988334f552895d23ed4085d3fd014a2'), ('ssvid', 'None'), 
