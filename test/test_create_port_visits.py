...
expected_1 = OrderedDict([('visit_id', '5f7c9418d55d07a5087874af60c2375a'),('track_id', '412424227'),
    ...
    ('events', [
        OrderedDict([('anchorage_id', u'345328af'),
            ...
            ('vessel_lon', 122.4564437866), ('track_id', 412424227), ('timestamp', 1476426402.0),
            ('event_type', u'PORT_ENTRY')]),
        OrderedDict([('anchorage_id', u'3452d969'), ('lat', 29.9407869352), ('lon', 122.27906699),
            ('vessel_lat', 29.9408073425), ('vessel_lon', 122.2787628174), ('track_id', 412424227),
        ...
        OrderedDict([('anchorage_id', u'3452d95d'),
            ...
            ('vessel_lon', 122.2749481201), ('track_id', 412424227), ('timestamp', 1476436086.0),
...
expected_2 = OrderedDict([('visit_id', 'b1e7e8bc8760dd2e50f49d9994e8dda9'),('track_id', '273386660'),
    ...
    ('events', [
        OrderedDict([('anchorage_id', u'41abf04b'), ('lat', 45.7285312075), ('lon', 47.6336454619),
            ('vessel_lat', 45.7202682495), ('vessel_lon', 47.6396331787), ('track_id', 273386660),
            ('timestamp', 1475241790.0), ('event_type', u'PORT_ENTRY')]),
        OrderedDict([('anchorage_id', u'41a90fa9'), ('lat', 46.3280197425), ('lon', 47.9900577312),
            ('vessel_lat', 46.3271255493), ('vessel_lon', 47.9901542664), ('track_id', 273386660),
        ...
        OrderedDict([('anchorage_id', u'41a90f75'),
            ...
            ('vessel_lon', 48.0045700073), ('track_id', 273386660), ('timestamp', 1475258350.0),
            ('event_type', u'PORT_STOP_END')]),
        OrderedDict([('anchorage_id', u'41a90f75'), ('lat', 46.3406197011), ('lon', 48.0045788836),
            ('vessel_lat', 46.3400001526), ('vessel_lon', 48.0033340454), ('track_id', 273386660),
        ...
        OrderedDict([('anchorage_id', u'41a90e45'), ('lat', 46.3122421582), ('lon', 47.9769367751),
            ('vessel_lat', 46.3120269775), ('vessel_lon', 47.9736251831), ('track_id', 273386660),
...
events_3 = [
        OrderedDict([('anchorage_id', u'3452d95f'), ('lat', 29.941832869), ('lon', 122.2689838563),
            ('vessel_lat', 29.9417858124), ('vessel_lon', 122.2697219849), ('track_id', 412424227),
        ...
        OrderedDict([('anchorage_id', u'3452d95d'), ('lat', 29.9399344611), ('lon', 122.2747471358),
            ('vessel_lat', 29.9404067993), ('vessel_lon', 122.2765045166), ('track_id', 412424227),
            ('timestamp', 1476426400.0), ('event_type', u'PORT_STOP_END')]),
        OrderedDict([('anchorage_id', u'345328af'), ('lat', 29.9667462525), ('lon', 122.4396281067),
            ('vessel_lat', 30.0182361603), ('vessel_lon', 122.475944519), ('track_id', 412424227),
            ('timestamp', 1476426401.0), ('event_type', u'PORT_EXIT')]),
        OrderedDict([('anchorage_id', u'345328af'), ('lat', 29.9667462525), ('lon', 122.4396281067),
            ('vessel_lat', 29.9806137085), ('vessel_lon', 122.4564437866), ('track_id', 412424227),
            ('timestamp', 1476426401.8), ('event_type', u'PORT_ENTRY')]),
        OrderedDict([('anchorage_id', u'3452d969'), ('lat', 29.9407869352), ('lon', 122.27906699),
            ('vessel_lat', 29.9408073425), ('vessel_lon', 122.2787628174), ('track_id', 412424227),
            ('timestamp', 1476426401.9), ('event_type', u'PORT_STOP_BEGIN')]),
        OrderedDict([('anchorage_id', u'345328af'), ('lat', 29.9667462525), ('lon', 122.4396281067),
            ('vessel_lat', 29.9806137085), ('vessel_lon', 122.4564437866), ('track_id', 412424227),
            ('timestamp', 1476426402.0), ('event_type', u'PORT_ENTRY')]),
        OrderedDict([('anchorage_id', u'3452d969'), ('lat', 29.9407869352), ('lon', 122.27906699),
            ('vessel_lat', 29.9408073425), ('vessel_lon', 122.2787628174), ('track_id', 412424227),
            ('timestamp', 1476430743.0), ('event_type', u'PORT_STOP_BEGIN')]),
        OrderedDict([('anchorage_id', u'3452d95d'), ('lat', 29.9399344611), ('lon', 122.2747471358),
            ('vessel_lat', 29.9394741058), ('vessel_lon', 122.2749481201), ('track_id', 412424227),
            ('timestamp', 1476436086.0), ('event_type', u'PORT_STOP_END')]),
        OrderedDict([('anchorage_id', u'3452d95f'), ('lat', 29.941832869), ('lon', 122.2689838563),
            ('vessel_lat', 29.9417858124), ('vessel_lon', 122.2697219849), ('track_id', 412424227),
            ('timestamp', 1476488638.0), ('event_type', u'PORT_STOP_BEGIN')]),
        OrderedDict([('anchorage_id', u'3452d95d'), ('lat', 29.9399344611), ('lon', 122.2747471358),
            ('vessel_lat', 29.9404067993), ('vessel_lon', 122.2765045166), ('track_id', 412424227),
            ('timestamp', 1476489542.0), ('event_type', u'PORT_STOP_END')]),
        OrderedDict([('anchorage_id', u'345328af'), ('lat', 29.9667462525), ('lon', 122.4396281067),
            ('vessel_lat', 30.0182361603), ('vessel_lon', 122.475944519), ('track_id', 412424227),
            ('timestamp', 1476495140.0), ('event_type', u'PORT_EXIT')])]
