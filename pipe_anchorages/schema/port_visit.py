...
def build():
    ...
    builder.add("visit_id", "STRING", description="Unique ID for this visit")
    builder.add(
        "vessel_id", "STRING", description="`vessel_id` of the track this visit was found on"
    )
    builder.add(
        "ssvid",
        "STRING",
    ...
    builder.add("start_lat", "FLOAT", description="latitude of vessel at `start_timestamp`")
    builder.add("start_lon", "FLOAT", description="longitude of vessel at `start_timestamp`")
    builder.add(
        "start_anchorage_id",
        "STRING",
    ...
    builder.add("end_lat", "FLOAT", description="latitude of vessel at `end_timestamp`")
    builder.add("end_lon", "FLOAT", description="longitude of vessel at `end_timestamp`")
    builder.add("duration_hrs", "FLOAT", description="duration of visit in hours")
    builder.add("end_anchorage_id", "STRING", description="longitude of vessel at `end_timestamp`")
    cdescr = """How confident are we that this is a real visit based on components of the visits:
