...
class AnchorageSink(PTransform):
    ...
    def encode(self, anchorage):
        return {
            ...
            'unique_stationary_vessel_ids' : len(anchorage.vessels),
            'unique_stationary_fishing_vessel_ids' : len(anchorage.fishing_vessels),
            'unique_active_vessel_ids' : anchorage.active_vessel_ids,
            'unique_total_vessel_ids' : anchorage.total_vessel_ids,
            'active_vessel_id_days': anchorage.active_vessel_id_days,
            'stationary_vessel_id_days': anchorage.stationary_vessel_id_days,
            'stationary_fishing_vessel_id_days': anchorage.stationary_fishing_vessel_id_days,
            's2id': anchorage.s2id,   
            }
    ...
    spec = {
            ...
            "unique_stationary_vessel_ids": "integer",
            "unique_stationary_fishing_vessel_ids": "integer",
            "unique_active_vessel_ids": "integer",
            "unique_total_vessel_ids": "integer",
            'active_vessel_id_days': "float",
            "stationary_vessel_id_days": "float",
            "stationary_fishing_vessel_id_days": "float",
            "s2id": "string",
        }
