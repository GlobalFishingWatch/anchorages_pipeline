...
class AnchorageSink(PTransform):
    ...
    def encode(self, anchorage):
        return {
            ...
            'unique_active_ssvid' : anchorage.active_vessel_ids,
            'unique_total_ssvid' : anchorage.total_vessel_ids,
            'active_ssvid_days': anchorage.active_vessel_id_days,
            'stationary_ssvid_days': anchorage.stationary_vessel_id_days,
            'stationary_fishing_ssvid_days': anchorage.stationary_fishing_vessel_id_days,
            's2id': anchorage.s2id,   
            }
